  ...
  "group/button inline-flex shrink-0 items-center justify-center rounded-lg border border-transparent bg-clip-padding text-sm font-medium whitespace-nowrap transition-all outline-none select-none active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        ...
        surface:
          "bg-surface-button text-text-warm rounded-[3px] hover:bg-surface-button/80 border-none [&_svg]:text-text-warm",
      },
      size: {
        default:
        ...
        "icon-lg": "size-9",
        "icon-24": "size-6 p-[6px] rounded-[3px] [&_svg]:size-3",
        compact: "h-6 gap-1 px-2 py-1 text-xs rounded-[3px] [&_svg:not([class*='size-'])]:size-3",
      },
    },
    defaultVariants: {
      variant: "default",
